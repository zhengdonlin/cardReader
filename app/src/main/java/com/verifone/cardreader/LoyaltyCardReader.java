 ...
 */
package com.verifone.cardreader;
...
public class LoyaltyCardReader implements NfcAdapter.ReaderCallback {
    ...
    String gotData = "is not card emulation", finalGotData = "";
    ...
    public void onTagDiscovered(Tag tag) {
        ...
        Log.i(TAG, "New tag discovered" + tag);


        IsoDep isoDep = IsoDep.get(tag);

        Log.i(TAG, "isoDep discovered = " + isoDep);
...
//                isoDep.setTimeout(3600);
                ...
                Log.i(TAG, "Sending: " + selCommand.toString());
                ...
                Log.i(TAG, " result : " + new String(result,"UTF-8"));
                Log.i(TAG, "statusWord : " + new String(statusWord,"UTF-8") + "  Select : " + new String(SELECT_OK_SW,"UTF-8") + " resultLength : " + resultLength);

                Log.i(TAG, " status : " + Arrays.equals(SELECT_OK_SW, statusWord));
                if (Arrays.equals(SELECT_OK_SW, statusWord)) {
                    // The remote NFC device will immediately respond with its stored account number
                    String accountNumber = new String(payload, "UTF-8");
                    gotData = accountNumber;
